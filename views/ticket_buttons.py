...
from db import close_ticket, delete_ticket, set_claim, get_ticket_by_channel, reopen_ticket
import time
...
class TicketButtonsView(View):
    ...
    async def close(self, interaction: discord.Interaction, button: discord.Button):
        ...
        t_id = row[0]
        close_ticket(t_id)
        embed = discord.Embed(description=f"Ticket closed by {interaction.user.mention}", color=discord.Color.red())
